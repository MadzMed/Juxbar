...
Bar.create(name: "Mama Shelter", address: "19 Rue Poquelin Molière, 33000 Bordeaux", user_id: p.id, description: "Au cœur de la Gironde, à quelques encablures des plages de l’Atlantique, la cité de Bordeaux, capitale mondiale de l’œnologie, est une bonne vivante, attablée avec ses amis du monde entier.", image: "https://cms.mamashelter.com/bordeaux/wp-content/uploads/sites/2/2019/10/Mama-Bordeaux-Insta-2017_212_2.jpg")
...
Bar.create(name: "Empire", address: "14 Rue de la Devise, 33000 Bordeaux", user_id: m.id, description: "Aménagé dans un bâtiment ancien aux pierres apparentes, ce bar propose des vins et d'autres boissons.", image: "https://uploads.lebonbon.fr/source/2018/bdx/mai/Lempire630Bar.jpg")
Bar.create(name: "Iboat", address: "3 Cours Henri Brunet, 33300 Bordeaux", user_id: f.id, description: "Solidement ancré dans sa ville et dans son quartier, l’IBOAT se positionne comme un outil de diffusion atypique et indépendant. Porteur d’une politique culturelle curieuse et ambitieuse, l’équipage déploie ponctuellement son action en dehors des murs.", image: "https://medias.otbor.vm.aiprod.com/original/LOIAQU033V500OJ6/0-Entree-iboat-nuit-2.jpg")
